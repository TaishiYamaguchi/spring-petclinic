...
class PetController {
	...
	/**
	 * ペットIDからペット情報を取得します。 IDが指定されていない場合は新しいペットオブジェクトを返します。
	 * @param ownerId オーナーID
	...
	/**
	 * オーナー用のデータバインダーを初期化します。 セキュリティ上の理由から、idフィールドのバインディングを禁止します。
	...
	/**
	 * ペット用のデータバインダーを初期化します。 カスタムバリデーターを設定します。
	 * @param dataBinder Webデータバインダー
	 */
	@InitBinder("pet")
	...
	/**
	 * 新しいペットを作成するフォームの送信を処理します。 名前の重複チェックと生年月日のバリデーションを行います。
	 * @param owner オーナーオブジェクト
	...
	/**
	 * ペット更新フォームの送信を処理します。 名前の重複チェックと生年月日のバリデーションを行います。
	 * @param owner オーナーオブジェクト
	...
	/**
	 * ペットの詳細情報を更新します。 既存のペットがあれば更新し、なければ新規追加します。
	 * @param owner ペットの飼い主
	 * @param pet 更新するペット情報
	 */
